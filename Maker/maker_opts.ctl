...
genome=Mn35.fasta #genome sequence (fasta file or fasta embeded in GFF3 file)
...
protein=thraust_peps.fa #protein sequence file in fasta format (i.e. from mutiple oransisms)
...
#-----Gene Prediction
snaphmm=Mn35.snap_intronlen.hmm #SNAP HMM file
gmhmm=Mn35.genemark.421.hmm #GeneMark HMM file
augustus_species=Mn35_CEGMA_CRF #Augustus gene prediction species model
